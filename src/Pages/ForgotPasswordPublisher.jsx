...
const ForgotPasswordPublisher = () => {
  ...
  const handleSendOtp = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`http://13.201.203.99:8089/user/publishers/reset-password/${email}`);
  ...
  const handleVerifyOtp = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`http://13.201.203.99:8089/user/publishers/verify-otp/${email}/${otp}`, null, {
        params: {
          otp: otp,
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await axios.put(`http://13.201.203.99:8089/user/publishers/update-password`, null, {
        params: {
          email: email,
          newPassword: newPassword
        },
